...
const TEAM = [
  {
    ...
    avatar: "https://avatars.githubusercontent.com/u/277614228?s=48&v=4",
    ...
    github: "https://github.com/PranavSagarXD/",
  },
  {
    name: "Shivalay",
    role: "Maintainer",
    avatar: "https://avatars.githubusercontent.com/u/283457753?s=48&v=4",
    bio: "Helping maintain and improve StreamDock to keep it running smoothly for the community.",
    github: "https://github.com/hello-type",
  },
];
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12 md:px-6">
      <header className="mb-10 text-center">
        <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl">About StreamDock</h1>
        <p className="mt-2 text-[var(--fg-muted)]">The story behind the list 💜</p>
      </header>

      <section className="streamdock-card mb-10 p-8">
        <h2 className="mb-3 text-xl font-bold">Our Mission</h2>
        <p className="mb-3 text-[var(--fg-muted)]">
          Welcome to <strong className="text-[var(--fg)]">StreamDock</strong> — your guide to free
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {TEAM.map((m) => (
            <div key={m.name} className="streamdock-card flex flex-col items-center p-8 text-center">
              <Image
                src={m.avatar}
                alt={m.name}
                width={110}
