...
export default function DmcaPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12 md:px-6">
      ...
      <section className="streamdock-card mb-8 p-6 md:p-8">
        ...
        <p className="text-[var(--fg-muted)]">
          <strong className="text-[var(--fg)]">Please Note:</strong> StreamDock is a directory service that provides links
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {STEPS.map((s) => (
            <div key={s.n} className="streamdock-card p-5 text-center">
      ...
      <section className="mb-8">
        ...
        <div className="streamdock-card divide-y p-2" style={{ borderColor: "var(--border)" }}>
          {REQUIREMENTS.map((r) => (
      ...
      <section className="streamdock-card p-8 text-center">
