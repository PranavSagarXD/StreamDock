      ...
      <div className="relative grid items-center gap-6 px-5 py-8 md:px-10 md:py-12 lg:grid-cols-[1.4fr_1fr]">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-3">
            <Image src="/logo.png" alt="StreamDock" width={44} height={44} className="h-10 w-10 rounded-xl md:h-11 md:w-11" />
            <div>
              <div className="text-[10px] font-semibold uppercase tracking-[0.25em] text-[var(--accent)]">The Ultimate Stream Collection</div>
