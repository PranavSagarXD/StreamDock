    ...
    >
      <div className="mx-auto flex max-w-[1600px] items-center gap-2 px-3 py-2.5 sm:gap-3 sm:px-4 md:px-6 md:py-3">
        <Link href="/" className="flex shrink-0 items-center gap-2 font-bold">
          <Image src="/logo.png" alt="StreamDock" width={28} height={28} className="h-7 w-7 rounded" />
          <span className="hidden text-base sm:inline">StreamDock</span>
        </Link>
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
          ...
          <button
            ...
            onClick={openPalette}
            aria-label="Search"
            className="streamdock-pill hidden h-9 items-center gap-2 px-3 text-sm lg:inline-flex"
          >
            <Search size={14} />
          ...
          <button
            ...
            onClick={openPalette}
            aria-label="Search"
            className="streamdock-pill inline-flex h-9 w-9 items-center justify-center lg:hidden"
          >
            <Search size={16} />
          </button>
          ...
          {/* Discord (mobile only — desktop has the sidebar banner) */}
          <a
            href="https://dsc.gg/rip-craftex"
            target="_blank"
            rel="noreferrer noopener"
            aria-label="Discord"
            className="streamdock-pill inline-flex h-9 w-9 items-center justify-center md:hidden"
          >
