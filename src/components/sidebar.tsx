      ...
      <div className="sticky top-20 space-y-1">
        ...
        <div className="px-3 pt-1">
          <a
            ...
            className="mb-3 block overflow-hidden rounded-md transition hover:opacity-90"
          >
            <div
            ...
            >
              ...
              <div className="min-w-0">
                <div className="text-sm font-semibold text-[var(--fg)]">StreamX</div>
                <div className="text-[10px] text-[var(--fg-muted)]">Premium streaming</div>
              </div>
            </div>
          </a>
        </div>
