...
export function SiteCard({ site, categoryId }: Props) {
  ...
  return (
    <a
      ...
      className={cn(
        "streamdock-card group relative flex aspect-[5/3] flex-col items-center justify-center gap-1.5 overflow-hidden p-3",
        "transition-transform duration-200 will-change-transform hover:-translate-y-0.5 hover:streamdock-glow",
